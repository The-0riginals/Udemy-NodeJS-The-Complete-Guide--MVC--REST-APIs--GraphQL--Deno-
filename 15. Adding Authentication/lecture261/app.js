...
const { csrfSynchronisedProtection } = csrfSync({
    getTokenFromRequest: (req) => req.body['csrfToken'],//this is the name of the hidden input field in the form
});
...
app.use(csrfSynchronisedProtection);//this middleware must be registered after the session middleware
